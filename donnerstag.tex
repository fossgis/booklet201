...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sponsorentexte/203-dbg.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\abstractPhysik{%
  ...
  QGIS als Forschungswerkzeug in der\linebreak Archäologie
  \noVideo{10pt}%
}{%
  Anwendungen bei der mongolisch-deutschen \mbox{Orchon-Expedition}%
}{%
...
\vfill
\input{sponsorentexte/204-geops.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sponsorentexte/205-omniscale.tex}
\vspace{\baselineskip}
...
\abstractAudimax{%
  ...
  Korrekte räumliche Daten sind im Feld grundlegend, um Entscheidungen zu
  treffen. Die Möglichkeit zu haben, Daten zu validieren und Korrekturen sofort
  vorzunehmen, garantieren einen kompletten Lebenszyklus von qualitativ
  hochwertigen und zuverlässigen Informationen.  Sei es in Echtzeit in der
  Stadt mit 4G-Verbindung oder in abgelegenen Orten mit Offline-Daten, dank
  seiner nahtlosen Integration mit QGIS erlaubt QField effizientes Arbeit
  draußen im Feld.
}
...
\abstractMathe{}{%
  ...
  \item \emph{Arne Schubert:} Geschichten aus der Docker-Trickkiste
  \item \emph{David Arndt:} OGC-Diensteverwaltung über SVN
  \item \emph{Alexander Matheisen:} OpenLayers Editor 2
  \item \emph{Astrid Emde, Jörg Thomsen:} Auf dem Weg nach\linebreak QualityLand oder schon mittendrin?
  \item \emph{Christoph Jung:} Offline MapMatching~--QGIS-Plugin zum Abgleich einer Trajektorie mit einem Wegenetz
  \end{itemize}%
  \justifying
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sponsorentexte/209-latlon.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sponsorentexte/207-graphhopper.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sponsorentexte/212-gkg-kassel.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\abstractMathe{}{%
  ...
  \begin{itemize}
    \RaggedRight
    \setlength{\itemsep}{-2pt} % Aufzählungspunktabstand auf 0
  \item \emph{Christopher Lorenz:} osm\_address\_db~-- ein Statusbericht zu Adressen
  \item \emph{Wiard Frühling:} Kosten-Distanz-Analyse zur Berechnung von Snapping-Punkten auf dem Straßennetz
  \item \emph{Robert Klemm:} Neues zur LKW-Maut in Deutschland; Probleme in OSM?
  \item \emph{Tobias Knerr:} OSM in 3D: Facelift für OSM2World
  \end{itemize}%
  \justifying
}
...
%  Zu diesem Treffen sind Anwender und Entwickler der Web-GIS-Client-Suite Mapbender eingeladen. Aber
...
\abstractRecht{%
  ...
  Anwendertreffen deegree für INSPIRE \noVideo{10pt}%
}{%
}{%
