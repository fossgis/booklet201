...
\newTimeslot{13:00}
\abstractAudimax{%
  Dominik Helle, Frank Schwarzbach, Frank Pfeil%
}{%
  ...
  Hinweisen zum Ablauf und der Organisation.%
}
...
\abstractAudimax{}{Lightning Talks}{}{%
  \vspace{-2em}
  \begin{itemize}
    \RaggedRight
    \setlength{\itemsep}{-3pt} % Aufzählungspunktabstand auf 0
  \item \emph{Arnulf Christl:} Über die Motivation von KI
  \item \emph{Christian Mayer:} Was sollen diese komischen Adress-Codes?
  \item \emph{Astrid Emde:} OSGeo~-- Teil einer weltweiten Community OSGeo
  \end{itemize}%
  \justifying
}
...
\abstractPhysik{}{Lightning Talks}{}{%
  ...
  \item \emph{Tim Alder:} Pointclouds für OSM
  \item \emph{Johannes Kröger:} Leider kein LIDAR?
  \item \emph{Felix Kunde:} GPU-Datenbanken
  \item \emph{Alexey Valikov:} Der Preis der Karte
  \end{itemize}%
  \justifying
}
...
\abstractOther{%
  ...
  Die Abendveranstaltung \emph{Dialoge im Bärenzwinger} findet von 19:00 bis 23:00 Uhr statt. Das Buffet wird im
  direkt angrenzenden historische Kassemattengewölbe eröffnet. Der Bärenzwinger ist ein
  Studentenclub und liegt direkt an der historischen Altstadt, den Brühlschen Terrassen.

  Jeder Gast bekommt drei Getränkegutscheine, die an der Bar eingelöst werden. Bitte nehmen Sie keine
  Getränkegutscheine mit nach Hause, sondern geben sie übrige weiter.
}{Brühlscher Garten~1%
}
